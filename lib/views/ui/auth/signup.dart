  ...
  Widget build(BuildContext context) {
    return Consumer<SignupNotifier>(builder: (context, signupNotifier, child){
      ...
      appBar: PreferredSize(preferredSize: const Size.fromHeight(50),
        child: CustomAppBar(text : "Signup",
          ...
          children: [
            ...
            CustomeTextFiels(
             ...
             suffixIcon: GestureDetector(
              onTap: (){
                signupNotifier.isObscureText = !signupNotifier.isObscureText;
              },
              child: Icon(signupNotifier.isObscureText? Icons.visibility : Icons.visibility_off, color: Color(kDark.value),),
             ),
            ), 
            ...
            Align(
              ...
              child: GestureDetector(
                child: ReusableText(text: "Login", style: appstyle(14, Color(kDark.value), FontWeight.w500)),
                onTap: (){
